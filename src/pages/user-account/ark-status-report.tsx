...
function ArkStatusReport() {
    return (
        <motion.div
            ...
            />
            <div className='md:col-span-10 sm:col-span-7 col-span-4'>
                <motion.div
                    initial="initial"
                    animate="animate"
                    variants={fadeInUp}
                ...
                <motion.div
                    className="lg:pr-10 pr-2 min-h-screen text-white col-span-10 py-4 flex flex-col justify-center"
                    initial="initial"
                    animate="animate"
                    variants={fadeInUp}>
                    <AccessLevels />
                    <section className="lg:px-4 px-2 pb-10 space-y-8 text-white">
                        ...
                        <motion.div
                            ...
                            <motion.div
                                ...
                                animate="animate"
                                variants={fadeInUp}>
                                <h2 className="lg:text-xl text-xs text-center font-mokoto tracking-wider mb-6">VESTED TOKENS</h2>
                                <div className='bg-white/13 rounded-[16px] pt-8 pb-6'>
                                    ...
                                    <div className='lg:p-6 px-2 py-4 pb-0'>
                                        {/* Progress Bar */}
                            ...
                            <motion.div
                                ...
                                animate="animate"
                                variants={fadeInUp}>
                                <h2 className="lg:text-xl text-xs text-center font-mokoto tracking-wider mb-6">LEADERBOARD</h2>
