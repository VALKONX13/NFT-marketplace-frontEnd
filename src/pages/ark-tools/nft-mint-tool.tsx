...
function CreateNft() {
  ...
  return (
    <div className="bg-redark-navy text-white flex lg:gap-8 gap-2 h-auto min-h-screen">
      <Sidebar
      ...
      />
      <div className="md:col-span-11 lg:col-span-9 2xl:col-span-10 sm:col-span-7 col-span-4 w-full">
