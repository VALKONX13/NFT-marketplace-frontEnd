    ...
    <div className="bg-redark-navy flex md:gap-8 gap-2 h-auto min-h-screen">
      ...
      <motion.div
        ...
        <div className="py-6 px-4 text-white space-y-6 2xl:max-w-[50%] xl:max-w-[70%] pt-26 mb-18">
          ...
          {/* Genesis Whitelist */}
          <section>
            <h3 className="md:text-2xl text-lg tracking-widest mokoto-regular mb-6">GENESIS WHITELIST</h3>
          ...
          {/* Quantum Whitelist */}
          <section>
            <h3 className="md:text-2xl text-lg tracking-widest mokoto-regular mb-6">QUANTUM WHITELIST</h3>
            <RedarkInput placeholder="Addresss" />
            <div className="flex md:flex-row flex-col md:gap-12 gap-4 mt-5 mb-8">
          ...
          {/* Tier Qualifications */}
          <section>
            <h3 className="md:text-2xl text-lg tracking-widest mokoto-regular mb-6">TIER QUALIFICATIONS</h3>
