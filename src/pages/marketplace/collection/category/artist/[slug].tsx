      ...
      <motion.div
        ...
        <div className="col-span-12 grid grid-cols-12 gap-5 gap-y-8 md:py-10 pt-5 2xl:pt-20">
          ...
          <div className="col-span-12 flex-col gap-10 hidden md:flex pr-6">
            <PaginationContainer title="Following" display="flex flex-col md:flex-row overflow-scroll" itemsPerPage={5}>
            ...
            <PaginationContainer title="Followers" display="flex flex-col md:flex-row overflow-scroll" itemsPerPage={5}>
              {dummyAvatars.map((item) => (
                <UserCard
                  key={item.id}
                  id={item.id}
