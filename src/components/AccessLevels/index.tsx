...
const AccessLevels = () => {
    return (
        <section className="text-white px-4 py-10 space-y-6">
            {/* Section Heading */}
            <div className="flex flex-col gap-4 mt-16">
                <h2 className="text-3xl font-mokoto tracking-widest">ARK STATUS REPORT</h2>
                <p className="text-xl font-mokoto tracking-widest mt-1">ACCESS LEVELS</p>
            </div>

            {/* Tier Summary Card */}
            <div className="border-2 border-white rounded-[20px] p-4 flex flex-col md:flex-row justify-between items-center gap-4">
                <div className="flex items-center gap-3 w-[30%]">
                    <div className="bg-redark-purple/25 rounded-full h-[80px] w-[80px] flex items-center justify-center">
                        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" className="">
                    ...
                    <div>
                        <p className="uppercase font-mokoto text-lg">ASCEND TIER (LEVEL 2)</p>
                        <div className="text-sm font-azeret flex justify-between">
                            <p>Wallet ID:</p>
                            <p className="text-redark-purple">0xA1...B74F</p>{" "}
                            <p className="bg-white text-redark-purple font-mokoto px-2 pb-0.5 pt-1.5 rounded-full text-[8px] ml-1">
                                ACTIVE
                            </p>
                        </div>
                    </div>
                ...
                <div className="flex-1">
                    <div className="text-sm font-azeret flex justify-between items-center mb-3">
