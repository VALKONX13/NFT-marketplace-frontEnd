    ...
    <div className="space-y-6">
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="grid grid-cols-1 lg:gap-6 gap-3 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 mb-4"
        >
      ...
      {/* Pagination */}
      <div className="flex items-center justify-center gap-4 md:pt-6 pb-5">
        <button
          onClick={handlePrev}
          disabled={page === 0}
